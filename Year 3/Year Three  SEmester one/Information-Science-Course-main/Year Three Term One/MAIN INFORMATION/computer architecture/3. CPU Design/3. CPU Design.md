## CPU Design audio podcast:- ![[Year Three Term One/MAIN INFORMATION/computer architecture/3. CPU Design/CPU Design podcast/CPU Design_ Datapath and Control.wav]]
